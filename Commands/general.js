...
const handle = async (m, ctx) => {
    ...
    if (['menu', 'help', 'start', 'commands'].includes(command)) {
        ...
        const menu = [
            ...
            `┃❍ *${p}antiviewonce* on/off — Reveal view-once silently`,
            `┃❍ *${p}antitext* on/off — Delete non-admin texts instantly`,
            ...
            `┃❍ *${p}gimages* / *${p}googleimages* <query> — Google Images`,
            `┃❍ *${p}unsplash* / *${p}hqphoto* <query> — HD stock photo`,
            `┃❍ *${p}ttsearch* / *${p}tiktoksearch* <q> — TikTok search`,
            `┃❍ *${p}stickerfind* <keyword> — Search stickers`,
            `┃❍ *${p}playstore* / *${p}googleplay* <app> — Play Store`,
            `┃❍ *${p}npm* / *${p}npmsearch* <package> — npm search`,
            `┃❍ *${p}happymod* / *${p}apkmirror* <app> — APK search`,
            `┃❍ *${p}wattpad* / *${p}stories* <query> — Wattpad`,
            `┃❍ *${p}wikimedia* / *${p}wkmedia* <topic>`,
            `┃❍ *${p}define2* / *${p}termdef* <term> — Define term`,
            '┃',
            '┃ ━━━━━━━━━━━━━━━━━━━━━━━━━━━',
            '┃ 🎵 *MUSIC & AUDIO TOOLS*',
            '┃ ━━━━━━━━━━━━━━━━━━━━━━━━━━━',
            `┃❍ *${p}lyrics* / *${p}lyricsv2* / *${p}lyrics2* <song>`,
            `┃❍ *${p}splyrics* / *${p}spotifylyrics* <song> — Spotify lyrics`,
            `┃❍ *${p}spplaylist* / *${p}spotifyplaylist* <name>`,
            `┃❍ *${p}soundcloud* / *${p}scmusic* <song or artist>`,
            `┃❍ *${p}hearthis* / *${p}htsearch* <artist>`,
            `┃❍ *${p}htset* / *${p}hearthisset* <set URL>`,
            `┃❍ *${p}chord* / *${p}chords* <song> — Guitar chords`,
            '┃',
            '┃ ━━━━━━━━━━━━━━━━━━━━━━━━━━━',
            '┃ 🛠️ *GIFTED TOOLS (NEW)*',
            '┃ ━━━━━━━━━━━━━━━━━━━━━━━━━━━',
            `┃❍ *${p}dns* / *${p}dnscheck* <domain> — DNS lookup`,
            `┃❍ *${p}headers* / *${p}httpheaders* <url>`,
            `┃❍ *${p}isup* / *${p}servercheck* <url> — Server check`,
            `┃❍ *${p}tobinary* / *${p}frombinary* <text/binary>`,
            `┃❍ *${p}b64enc* / *${p}b64dec* <text/base64>`,
            `┃❍ *${p}fancy* / *${p}fancyv2* <text> — Fancy text`,
            `┃❍ *${p}ttp* / *${p}textpic* <text> — Text to image`,
            `┃❍ *${p}emojimix* <😂> <🙄> — Fuse two emojis`,
            `┃❍ *${p}encrypt* / *${p}codeenc* <code> — Encrypt code`,
            `┃❍ *${p}obfuscatehtml* <html> — Obfuscate HTML`,
            `┃❍ *${p}carbon* / *${p}codeimg* <code> — Code → image`,
            `┃❍ *${p}topdf* / *${p}makepdf* <text> — Text → PDF`,
            `┃❍ *${p}quotecard* <text> | <name> — Quote card`,
            `┃❍ *${p}canvascard* <title> | <type> — Canvas card`,
            `┃❍ *${p}ssphone* / *${p}sstab* / *${p}sspc* <url>`,
            `┃❍ *${p}web2zip* / *${p}websitezip* <url>`,
            '┃',
            '┃ ━━━━━━━━━━━━━━━━━━━━━━━━━━━',
            '┃ ⚙️ *OWNER / ADMIN*',
            '┃ ━━━━━━━━━━━━━━━━━━━━━━━━━━━',
            ...
            '┃ 🛠️ *TOOLS & MONITORING*',
            '┃ ━━━━━━━━━━━━━━━━━━━━━━━━━━━',
            `┃❍ *${p}monitor* add/list/remove/check <url> — Site uptime`,
            `┃❍ *${p}alert* cpu/ram/disk <percent> — Health alerts`,
            `┃❍ *${p}shorten* <url> — Shorten any URL`,
            `┃❍ *${p}password* <length> — Generate strong password`,
            `┃❍ *${p}beramodel* <model> — Switch AI model`,
            `┃❍ *${p}mysys* set/show/clear <prompt> — Custom AI persona`,
            `┃❍ *${p}debug* [text] — Show intent detection result`,
            `┃❍ *${p}ghwebhook* on/off — GitHub webhook relay`,
            '┃',
