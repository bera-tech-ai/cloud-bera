...
const handle = async (m, { conn, text, reply, prefix, command, isOwner, sender, chat }) => {
    ...
    if (command === 'menu' || command === 'help' || command === 'start') {
        ...
        const lines = [
            ...
            '┃ 🖥️ *BERAHOST / SERVERS*',
            '┃ ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
            '┃❍ *' + p + 'bh* / *' + p + 'berahost* bots — List deployed bots',
            '┃❍ *' + p + 'bh* restart <id> — Restart a bot',
            '┃❍ *' + p + 'bh* logs <id> — Get bot logs',
            '┃❍ *' + p + 'bh* deploy <url> — Deploy from GitHub',
            '┃❍ *' + p + 'bh* env <id> KEY=VAL — Set env variable',
            '┃❍ *' + p + 'bh* domain add <domain> — Add custom domain',
            '┃❍ *' + p + 'ptlist* — List Pterodactyl servers',
            '┃❍ *' + p + 'ptstatus* <id> — Server status',
            '┃❍ *' + p + 'ptstart* / *' + p + 'ptstop* / *' + p + 'ptrestart* <id> — Power control',
            '┃❍ *' + p + 'ptcmd* <id> <cmd> — Run panel command',
            '┃❍ *' + p + 'ptwatch* <id> — Monitor server (alerts)',
            '┃',
            '┃ ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
            '┃ ⚙️ *OWNER / ADMIN TOOLS*',
            '┃ ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
